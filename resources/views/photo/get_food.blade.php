...
<div class="too-block__info_title">
	...
	<div class="too-block__info_body too-block__info_body___photo">
		<a href="/id<?php echo $v['owner_info'][0]['id'];?>"><i class="icon fly_block"  style="background-image: url('<?php echo $v['data']['big_photo'];?>');top:6px;margin-right:7px;background-color: #EEE;"></i><?php echo $v['owner_info'][0]['first_name'];?></a>
...
<div style="margin-top:14px"><?php echo $v['data']['text'];?></div>
