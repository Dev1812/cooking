...
<div class="nav">
  <div>
    ...
    <a href="/like" class="nav-wrap__item nav-wrap__item_active">лайки</a>

    <a href="/like/dis_like" class="nav-wrap__item">дизлайки</a>
...
<?php
if(empty($photos)) {
echo '<div class="block_not_found_empty">Ни найдено ни одного лайка</div>';
} else {
  echo '<div style="padding:7px 0;font-weight:bold;">Лайки('.$likes_counter.')</div>';
foreach($photos as $v) {
