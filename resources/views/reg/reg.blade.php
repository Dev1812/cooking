...
<div class="form_section">
	...
	<div class="form_big_input_section__body">
		<div class="form_big_input_section__wrap"><input type="text" name="" placeholder="Ваше имя" class="form_big_input_section__text_field"></div>
	</div>
</div>
...
<div class="form_section">
	...
	<div class="form_big_input_section__body">
		<div class="form_big_input_section__wrap"><input type="text" name="" placeholder="Ваша фамилия" class="form_big_input_section__text_field"></div>
	</div>
</div>
...
<div class="form_section">
	...
	<div class="form_big_input_section__body">
		<div class="form_big_input_section__wrap"><input type="text" name="" placeholder="Ваш логин" class="form_big_input_section__text_field"></div>
	</div>
</div>
...
<div class="form_section">
	...
	<div class="form_big_input_section__body">
		<div class="form_big_input_section__wrap"><input type="text" name="" placeholder="Ваш email" class="form_big_input_section__text_field"></div>
	</div>
</div>
...
<div class="form_section">
	...
	<div class="form_big_input_section__body">
		<div class="form_big_input_section__wrap"><input type="text" name="" placeholder="Ваш пароль" class="form_big_input_section__text_field"></div>
	</div>
</div>
...
<div class="form_section" style="margin-top: 9px">
	<div class="form_big_input_section__body">
		<div class="form_big_input_section__wrap"><input type="submit" name="" placeholder="Ваше Имя" class="button" value="Зарегестрироваться"></div>
	</div>
</div>
